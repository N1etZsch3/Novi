...
public interface AiPromptConfigService {
     ...
     * @return 对应场景的系统提示词模板
     */
    String getSystemPromptByContext(com.n1etzsch3.novi.common.enums.PromptContextType contextType);
     ...
     */
    void addConfig(com.n1etzsch3.novi.common.pojo.entity.AiPromptConfig config);
     ...
     * @return 匹配类型的配置列表。
     */
    java.util.List<com.n1etzsch3.novi.common.pojo.entity.AiPromptConfig> listConfigsByType(Integer type);
}

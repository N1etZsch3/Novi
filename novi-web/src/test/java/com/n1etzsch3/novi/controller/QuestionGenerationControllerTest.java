...
class QuestionGenerationControllerTest {
    ...
    @MockBean
    private com.n1etzsch3.novi.user.interceptor.JwtAuthInterceptor jwtAuthInterceptor;
    ...
    void deleteRecord_Success() throws Exception {
        mockMvc.perform(org.springframework.test.web.servlet.request.MockMvcRequestBuilders
                .delete("/api/v1/questions/history/1"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.code").value(1));

        verify(questionGenerationService).deleteGenerationRecord(1L, 1L);
    }
}
